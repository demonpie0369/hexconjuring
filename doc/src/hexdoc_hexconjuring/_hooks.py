...
import hexdoc_hexconjuring

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexconjuringPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexconjuringModPlugin(branch=branch)


class HexconjuringModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexconjuring"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexconjuring, "_templates"
