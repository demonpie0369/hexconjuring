package net.hexconjuring.api.config;
 ...
 */
public class HexconjuringConfig {
    ...
    public static void setCommon(CommonConfigAccess common) {
        if (HexconjuringConfig.common != dummyCommon) {
            Hexconjuring.LOGGER.warn("CommonConfigAccess was replaced! Old {} New {}", HexconjuringConfig.common.getClass().getName(), common.getClass().getName());
        }
        HexconjuringConfig.common = common;
    }
    ...
    public static void setClient(ClientConfigAccess client) {
        if (HexconjuringConfig.client != dummyClient) {
            Hexconjuring.LOGGER.warn("ClientConfigAccess was replaced! Old {} New {}", HexconjuringConfig.client.getClass().getName(), client.getClass().getName());
        }
        HexconjuringConfig.client = client;
    }
    ...
    public static void setServer(ServerConfigAccess server) {
        ...
        if (HexconjuringConfig.server != dummyServer) {
            Hexconjuring.LOGGER.warn("ServerConfigAccess was replaced! Old {} New {}", HexconjuringConfig.server.getClass().getName(), server.getClass().getName());
        }
        HexconjuringConfig.server = server;
    }
